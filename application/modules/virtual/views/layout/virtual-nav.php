...
<div id="menu-superior" class="hidden-xs hidden-sm">
    <div class="container">
        <ul>
            ...
            <li><a  href="<?= base_url('virtual-empresa'); ?>" title="conhe&ccedil;a a VOLPATO"><strong>EMPRESA</strong></a></li>
            <li class="separador"></li>
            <li><a href="https://volpato.blog.br/category/portaria/" title="Ultimas do Blog "><strong>BLOG</strong></a></li>
            <li class="separador"></li>
            <li><a href="<?= base_url('virtual-contato'); ?>" title="Fale Conosco"><strong>CONTATO</strong></a></li>
            <li class="separador"></li>
            <li><a   target="blanck"  href="https://grupovolpato.pandape.com.br/" title="Trabalhe Conosco"><strong>TRABALHE CONOSCO</strong></a></li>
...
<section id="header-mobile" class="visible-xs visible-sm">
    ...
    <nav class="hidden-md nav-mobile collapse" id="menu-xs" aria-expanded="false" style="height: 0px;">					
        <ul class="nav">
            ...
            <li class="list-item"><a href="<?=base_url('virtual/empresa'); ?>" title="conhe&ccedil;a a VOLPATO"><strong>EMPRESA</strong></a></li>
            <li class="list-item"><a href="https://volpato.blog.br/category/portaria/" title="Ultimas do Blog">BLOG</a></li>
            <li class="list-item"><a href="<?=base_url("virtual/contato"); ?>" title="Fale Conosco">CONTATO</a></li>
            <li class="list-item"><a href="https://grupovolpato.pandape.com.br/"  target="blanck" title="Trabalhe Conosco">TRABALHE CONOSCO</a></li>
        </ul>					
    </nav>
</section>