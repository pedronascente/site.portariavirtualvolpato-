...
class presencial extends MX_Controller
{
	...
	{
		$this->loadPage('presencial/index');
	}

	public function empresa()
	{
		$this->loadPage('presencial/empresa');
	}

	public function contato()
	{
		$this->loadPage('presencial/contato');
	}

	public function obrigado()
	{
		$this->loadPage('presencial/obrigado');
	}
	...
	public function salvar()
	{
		...
		redirect(base_url('/presencial'), 'refresh');
	}
	...
	private function formatarMensagemEmailContato()
	{
		...
		$mensagem .= '<tr><td><b>Origem:</b></td><td>' . $dados['cf_origem'] . '</td></tr>';
	...
	private function EnviarEmail($mensagem, $assunto = 'novas Leads portaria')
	{
		...
		$this->email->to("simuladorvolpato@gmail.com,desenvolvimento@grupovolpato.com");
