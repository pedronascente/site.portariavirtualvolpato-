        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="form-group">
                    <input type="text" name="name" class="form-control " placeholder="Nome" required="" value="cliente teste 0231321">
                </div>
                <div class="form-group">
                    <input type="text" name="personal_phone" data-mask-type="telefone" class="form-control" maxlength="20" placeholder="Telefone" required="" value="51 92399999">
                </div>
                <div class="form-group">
                    <input type="email" name="email" class="form-control" placeholder="E-mail" required="" value="email@bol.com">
                </div>
